...
def generate_graphic_two_models(loss1, loss2, data, save=False):
    """
    Function to generate a plot of the errors/loss for models 2.1 or 2.2
    Args:
        loss1: list containing as many lists as runs. Each inner list contains the loss for the first model along the train.
            size = [[n_epochs],[n_epochs],...,[n_epochs]](n_runs)
        loss2: list containing as many lists as runs. Each inner list contains the loss for the second model along the train.
            size = [[n_epochs],[n_epochs],...,[n_epochs]](n_runs)
